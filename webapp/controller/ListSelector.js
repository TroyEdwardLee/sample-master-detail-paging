sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("sample.master.detail.sample-master-detail-paging.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias sample.master.detail.sample-master-detail-paging.controller.ListSelector
			 */
			 ...
			 * @return {sample.master.detail.sample-master-detail-paging.model.ListSelector} the list selector object for method chaining
			 * @public
			 */

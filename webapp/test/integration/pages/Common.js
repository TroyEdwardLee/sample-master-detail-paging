sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("sample/master/detail/sample-master-detail-paging/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#MyOrders-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#MyOrders-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("sample.master.detail.sample-master-detail-paging.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sample/master/detail/sample-master-detail-paging/localService/mockserver"], function (mockserver) {
